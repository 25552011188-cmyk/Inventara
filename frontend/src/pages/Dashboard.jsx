...
export default function Dashboard() {
    ...
    const aktivitasHarian = [
        {
            label: "Barang Masuk",
            value: data.hari_ini.barang_masuk,
        ...
        {
            label: "Barang Keluar",
            value: data.hari_ini.barang_keluar,
        ...
        {
            label: "Pending",
            value: data.hari_ini.pending_keluar,
            icon: AlertTriangle,
        ...
        <div className="space-y-4 md:space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Selamat datang di Inventara - Sistem Monitoring Gudang
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                {stats.map((stat, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className="bg-white rounded-2xl p-4 md:p-6 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 group cursor-default"
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <div
                                    className={`w-10 h-10 md:w-12 md:h-12 ${stat.bgColor} rounded-xl flex items-center justify-center shadow-sm transition-transform duration-300 group-hover:scale-110`}
                                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 md:p-6">
                    ...
                    {data.top_barang_keluar.length > 0 ? (
                        ...
                        <div className="flex items-center justify-center h-52 text-gray-400 bg-gray-50 rounded-xl text-sm">
                            Belum ada data
                        </div>
                    )}
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 md:p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                    <div className="p-3 md:p-4 bg-blue-50/50 border border-blue-100 rounded-xl">
                        <p className="text-xs md:text-sm text-gray-600 mb-1">
                            Total Masuk
                        </p>
                        <p className="text-xl md:text-2xl font-bold text-blue-600">
                            {data.bulan_ini.total_masuk}
                        </p>
                    </div>
                    <div className="p-3 md:p-4 bg-indigo-50/50 border border-indigo-100 rounded-xl">
                        <p className="text-xs md:text-sm text-gray-600 mb-1">
                            Total Keluar
                        </p>
                        <p className="text-xl md:text-2xl font-bold text-indigo-600">
                            {data.bulan_ini.total_keluar}
                        </p>
                    </div>
                    <div className="p-3 md:p-4 bg-emerald-50/50 border border-emerald-100 rounded-xl">
                        <p className="text-xs md:text-sm text-gray-600 mb-1">
                            Transaksi Masuk
                        </p>
                        <p className="text-xl md:text-2xl font-bold text-emerald-600">
                            {data.bulan_ini.transaksi_masuk}
                        </p>
                    </div>
                    <div className="p-3 md:p-4 bg-amber-50/50 border border-amber-100 rounded-xl">
                        <p className="text-xs md:text-sm text-gray-600 mb-1">
                            Transaksi Keluar
                        </p>
                        <p className="text-xl md:text-2xl font-bold text-amber-600">
                            {data.bulan_ini.transaksi_keluar}
                        </p>
                    </div>
                </div>
            </div>
